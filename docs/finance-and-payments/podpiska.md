...
Оплата обучения в Хекслете на тарифах **[Базовый план](/docs/formats-and-tarifs/tarifs/bazovyi-plan.md)** и **[Премиум-подписка](/docs/formats-and-tarifs/tarifs/archived-tarifs/tarif-premium-podpiska.md)** устроена по модели подписки — так же, как это работает в сервисах с музыкой, фильмами или сериалами. Студент указывает данные банковской карты, система списывает оплату за первый месяц, а затем автоматически продлевает доступ, снимая ту же сумму каждый месяц. Подписку на Базовый план также можно оформить со списанием каждые 1 или 3 года.

Подписку можно отменить в любой момент в разделе «[Оплата](https://ru.hexlet.io/account/subscription)». В этом случае дальнейших списаний не будет, а полный доступ к материалам сохранится до конца уже оплаченного периода.
...
Сменить карту самостоятельно в личном кабинете пока нельзя. Напишите нам в поддержку на [support@hexlet.io](mailto:support@hexlet.io) – поможем всё оформить.
...
Нет, после отмены подписки останется доступ только к теории пройденных уроков, а полный доступ возможен при активной подписке, вне зависимости от того, был пройден курс раньше или нет.
