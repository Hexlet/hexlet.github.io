...
- На старте обучения добавляет в учебный чат и выдаёт доступы к контенту.
...
- Оформляет студенту [академический отпуск](/docs/learning-process/akademicheskii-otpusk.md), если есть такая необходимость.
...
- Если вам нужна [пауза в обучении](/docs/learning-process/akademicheskii-otpusk.md).
