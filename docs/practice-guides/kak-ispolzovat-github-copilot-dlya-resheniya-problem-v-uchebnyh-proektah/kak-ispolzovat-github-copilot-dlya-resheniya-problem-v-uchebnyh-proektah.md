...
Зачем это нужно? Copilot подсказывает код в реальном времени, но это плохо для обучения, если нет понимания, что делает код. Чтобы избежать этого, важно использовать Copilot как инструмент для анализа и изучения, а не как источник готовых решений.
...
Убедитесь, что Copilot включён — на странице настроек будет показан его статус. В разделе **Visibility** проверьте, что показ Copilot включён.
...
4. **Напишите промпт для Copilot** — например:
   ...
   > Сделай ревью тест-кейсов по следующему чеклисту: _чек-лист по тест-кейсам_
