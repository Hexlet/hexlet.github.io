...
Если вы хотели бы узнать, как сохранить свое решение на сайте, перейдите в [эту статью](/docs/practice/kak-sohranit-svoe-reshenie.md).
...
Если проект был сделан самостоятельно и принят автоматической проверкой, получить код-ревью от наставника тоже будет полезно. Для этого нужно сменить формат обучения и поработать с наставником индивидуально. Оставьте заявку на странице нужной программы, мы с вами свяжемся и поможем всё организовать: https://ru.hexlet.io/courses
